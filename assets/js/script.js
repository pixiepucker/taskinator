...
var taskFormHandler = function(event) {
    ...
    } // no data attribute, so create obj as normal and pass to createTaskEl
    else {
        var taskDataObj = {
            name: taskNameInput,
            type: taskTypeInput,
...
// 2. convert tasks from string format back into array of objects
// 3. use for loop to go through task array and create task elements on page from it
